...
public class ReciprocalArraySumTest { // extends TestCase
    // private static final Logger LOGGER = Logger.getLogger(ReciprocalArraySumTest.class.getName());
    ...
    private double parTestHelper(final int N, final boolean useManyTaskVersion, final int ntasks) {
        ...
        if (useManyTaskVersion) {
            sum = ReciprocalArraySum.ReciprocalArraySumTask.parManyTaskArraySum(input, ntasks);
        } else {
            assert ntasks == 2;
            sum = ReciprocalArraySum.ReciprocalArraySumTask.parArraySum(input);
        }
        ...
        for (int r = 0; r < REPEATS; r++) {
            if (useManyTaskVersion) {
                ReciprocalArraySum.ReciprocalArraySumTask.parManyTaskArraySum(input, ntasks);
            } else {
                assert ntasks == 2;
                ReciprocalArraySum.ReciprocalArraySumTask.parArraySum(input);
            }
        }
...
//    public void testParSimpleTen() {
//        final double minimalExpectedSpeedup = 1.5;
//        final double speedup = parTestHelper(100000, false, 2);
...
//
    ...
    public void testParManyTaskOneMillion() {
        ...
        ReciprocalArraySum.ReciprocalArraySumTask.threshold = 50;

        final double speedup = parTestHelper(1_000, true, ncores);
...
//        }
//
//        double actual = ReciprocalArraySum.ReciprocalArraySumTask.parArraySum(input);
...
//        List actual = ReciprocalArraySum.ReciprocalArraySumTask.findIndices(100, 4);
//        List expected = Arrays.asList(0, 25, 50, 75);
//        assertEquals(expected, actual);
//
//        actual = ReciprocalArraySum.ReciprocalArraySumTask.findIndices(99, 4);
//        expected = Arrays.asList(0, 25, 49, 73);
//        assertEquals(expected, actual);
//
//        actual = ReciprocalArraySum.ReciprocalArraySumTask.findIndices(96, 4);
//        expected = Arrays.asList(0, 24, 48, 72);
//        assertEquals(expected, actual);
//
//        actual = ReciprocalArraySum.ReciprocalArraySumTask.findIndices(124, 5);
//        expected = Arrays.asList(0, 25, 49, 73, 97);
//        assertEquals(expected, actual);
//    }
