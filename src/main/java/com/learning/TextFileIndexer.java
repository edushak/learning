...
public class TextFileIndexer {
    private static StandardAnalyzer analyzer = new StandardAnalyzer(CharArraySet.EMPTY_SET); // Version.LUCENE_8_1_1
    ...
    public static void main(String[] args) throws IOException {
        ...
        TopScoreDocCollector collector = TopScoreDocCollector.create(1, 10000);
    ...
    public void indexFileOrDirectory(String fileName) throws IOException {
        ...
        int originalNumDocs = writer.numRamDocs(); // numDocs();
        for (File f : queue) {
            FileReader fr = null;
            try {
        ...
        int newNumDocs = writer.numRamDocs(); // numDocs();
        System.out.println("");
        System.out.println("************************");
